...
compiler_analysis_analyser_analyse:
	...
	movq %r12, %rdi
	movq %rax, %r12
	leaq compiler_analysis_analyser_analyse_fn(%rip), %rsi
...
compiler_analysis_analyser_analyse_unused_fns:
	...
	subq $8, %rsp
	pushq %rbx
	leaq compiler_analysis_analyser_fn_refs(%rip), %rsi
	movq %rdi, %rbx
	callq donna_list_flat_map
	movq %rbx, %rdi
	movq %rax, %rsi
...
.Lbb80:
	...
	movq %rbx, %rdi
	movq %rax, %rbx
	leaq compiler_analysis_analyser_analyse_clause(%rip), %rsi
	callq donna_list_flat_map
	movq %rbx, %rdi
	movq %rax, %rsi
	callq donna_list_append

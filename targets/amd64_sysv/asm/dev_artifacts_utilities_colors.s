...
utilities_colors_paint:
	...
	movq %rax, %rdi
	leaq utilities_colors_reset(%rip), %rsi
	callq __rt_str_concat
	leave
	ret
...
utilities_colors_error_header:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_bold_red(%rip), %rdi
...
utilities_colors_warning_header:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_bold_yellow(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_orange:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_color_orange(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_bold:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_style_bold(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_dim:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_style_dim(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_italic:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_style_italic(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_red:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_color_red(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_green:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_color_green(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_yellow:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_color_yellow(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_path:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_color_cyan(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_light_blue:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_color_light_blue(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret
...
utilities_colors_magenta:
	...
	movq %rsp, %rbp
	movq %rdi, %rsi
	leaq utilities_colors_color_magenta(%rip), %rdi
	callq utilities_colors_paint
	leave
	ret

...
Lbb19:
	...
	movq %r13, %rdi
	movq %rax, %rsi
	callq _compiler_parser_ast_ExprStmt
	movq %r12, %rsi
	movq %rax, %rdi
...
Lbb33:
	...
	movq %rax, %rdi
	movq %rsi, %r12
	callq _compiler_parser_ast_Block
	movq %rax, %rdi
...
Lbb70:
	...
	movq 16(%rax), %r14
	movq %r15, %rdx
	callq _compiler_parser_ast_LetPatStmt
	movq %r14, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	movq %rax, (%r13)
...
Lbb134:
	...
	movq 8(%rax), %rsi
	movq 16(%rax), %r12
	callq _compiler_parser_ast_Pipe
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_pipe_loop
	movq %rax, (%rbx)
...
Lbb147:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BOr(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_or_loop
	movq %rax, (%rbx)
...
Lbb161:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BAnd(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_and_loop
...
Lbb220:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BGtEqDot(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb224:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BGtDot(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb228:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BLtEqDot(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb232:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BLtDot(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb236:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BGtEq(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb240:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BGt(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb244:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BLtEq(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb248:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BLt(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb252:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BNotEq(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb256:
	...
	movq 8(%rax), %rdx
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_BEq(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb270:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BConcat(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_concat_loop
...
Lbb299:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BSubDot(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_add_loop
...
Lbb303:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BAddDot(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_add_loop
...
Lbb307:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BSub(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_add_loop
...
Lbb311:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BAdd(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_add_loop
...
Lbb345:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BDivDot(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_mul_loop
...
Lbb349:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BMulDot(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_mul_loop
...
Lbb353:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BMod(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_mul_loop
...
Lbb357:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BDiv(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_mul_loop
...
Lbb361:
	...
	movq 16(%rax), %rdi
	movq %rdi, %r12
	leaq _compiler_parser_ast_BMul(%rip), %rdi
	callq _compiler_parser_ast_BinOp
	movq %r12, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_mul_loop
...
Lbb376:
	...
	movq 8(%rax), %rsi
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_UNot(%rip), %rdi
	callq _compiler_parser_ast_UnaryOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	movq %rax, (%rbx)
...
Lbb379:
	...
	movq 8(%rax), %rsi
	movq 16(%rax), %r12
	leaq _compiler_parser_ast_UNeg(%rip), %rdi
	callq _compiler_parser_ast_UnaryOp
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
...
Lbb410:
	...
	movq 8(%rcx), %rsi
	movq 8(%rax), %rdx
	callq _compiler_parser_ast_FieldAccess
	movq %rbx, %rdi
	movq %rax, %rsi
	callq _compiler_parser_parse_exprs_parse_call_loop
	jmp Lbb416
...
Lbb437:
	cmpl $0, %ecx
	jnz Lbb439
	leaq _str2129(%rip), %rdi
	callq _utilities_location_zero
	movq %rax, %rsi
	leaq _str2128(%rip), %rdi
	callq _errors_error_ParseUnexpectedEof
	movq %rax, %rdi
	callq _compiler_parser_parse_result_PErr
	movq %rax, (%r12)
...
Lbb552:
	cmpl $0, %eax
	jnz Lbb554
	leaq _str2840(%rip), %rdi
	callq _utilities_location_zero
	movq %rax, %rsi
	leaq _str2839(%rip), %rdi
	callq _errors_error_ParseUnexpectedEof
	movq %rax, %rdi
	callq _compiler_parser_parse_result_PErr
	jmp Lbb590
...
Lbb568:
	cmpl $0, %ecx
	jnz Lbb570
	leaq _str2726(%rip), %rdi
	callq _utilities_location_zero
	movq %rax, %rsi
	leaq _str2725(%rip), %rdi
	callq _errors_error_ParseUnexpectedEof
	movq %rax, %rdi
	callq _compiler_parser_parse_result_PErr
	movq %rax, (%r12)
...
Lbb576:
	...
	movq 16(%rdi), %rbx
	movq 8(%rax), %rdi
	callq _compiler_parser_ast_Todo
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb590
Lbb577:
	...
	movq 8(%rax), %rdi
	movq 16(%rax), %r12
	callq _compiler_parser_ast_Panic
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	movq %rax, (%rbx)
...
Lbb580:
	...
	movq 8(%rax), %rdi
	movq 16(%rax), %r12
	callq _compiler_parser_ast_Echo
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	movq %rax, (%rbx)
...
Lbb583:
	...
	movq %rsi, %rbx
	movq 8(%rax), %rsi
	callq _compiler_parser_ast_Var
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb590
...
Lbb585:
	...
	movq 8(%rax), %rsi
	movl $0, %edi
	callq _compiler_parser_ast_BoolLit
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb590
...
Lbb587:
	...
	movq %rsi, %rbx
	movq 8(%rax), %rsi
	callq _compiler_parser_ast_StringLit
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb590
Lbb588:
	...
	movq %rsi, %rbx
	movq 8(%rax), %rsi
	callq _compiler_parser_ast_FloatLit
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb590
Lbb589:
	...
	movq %rsi, %rbx
	movq 8(%rax), %rsi
	callq _compiler_parser_ast_IntLit
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
Lbb590:
...
Lbb596:
	...
	callq _compiler_parser_ast_Tuple
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
Lbb597:
...
Lbb628:
	movq 16(%rax), %rbx
	leaq _donna_nil(%rip), %rdi
	callq _compiler_parser_ast_EList
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
Lbb629:
...
Lbb687:
	movq %rcx, %rsi
	movq 16(%rax), %r12
	callq _compiler_parser_ast_ListSpread
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	movq %rax, (%rbx)
...
Lbb709:
	...
	movq 8(%rax), %rsi
	movq 16(%rax), %r14
	callq _compiler_parser_ast_Case
	movq %r14, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	movq %rax, (%r13)
...
Lbb752:
	cmpl $0, %eax
	jnz Lbb754
	leaq _str3564(%rip), %rdi
	callq _utilities_location_zero
	movq %rax, %rsi
	leaq _str3563(%rip), %rdi
	callq _errors_error_ParseUnexpectedEof
	movq %rax, %rdi
	callq _compiler_parser_parse_result_PErr
	movq %rax, (%r13)

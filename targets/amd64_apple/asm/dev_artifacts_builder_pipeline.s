...
_builder_pipeline_sh_quote:
	...
	pushq %rbp
	movq %rsp, %rbp
	leaq _str420(%rip), %rdx
	leaq _str419(%rip), %rsi
	callq _donna_string_replace
	movq %rax, %rsi
...
_builder_pipeline_path_last_segment:
	...
	pushq %rbp
	movq %rsp, %rbp
	leaq _str719(%rip), %rsi
	callq _donna_string_split
	movq %rax, %rdi
	leaq _str721(%rip), %rsi

...
_builder_pipeline_sh_quote:
	...
	pushq %rbp
	movq %rsp, %rbp
	leaq _str425(%rip), %rdx
	leaq _str424(%rip), %rsi
	callq _donna_string_replace
	movq %rax, %rsi

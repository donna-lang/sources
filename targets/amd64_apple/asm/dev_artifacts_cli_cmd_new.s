...
_cli_cmd_new_run:
	...
	pushq %rbx
	pushq %r12
	callq _cli_cmd_new_first_positional
	movq %rax, %rdi
	leaq _str3(%rip), %rsi
	movq %rdi, %rbx
	callq _strcmp
	...
	cmpq $1, %rax
	jz Lbb3
	callq _cli_cmd_new_create_project
	movq %rax, (%rbx)
	jmp Lbb5
Lbb3:
	movq %rdi, %r12
...
_cli_cmd_new_create_project:
	...
	movq %rdi, %r13
	movq %rbx, %rdi
	callq _cli_cmd_new_toml_content
	movq %r13, %rdi
	movq %rax, %rsi
	...
	movq %rdi, %r13
	movq %rbx, %rdi
	callq _cli_cmd_new_main_content
	movq %r13, %rdi
	movq %rax, %rsi
	callq _donna_files_write
	leaq _str57(%rip), %rsi
	...
	movq %rdi, %r13
	movq %rbx, %rdi
	callq _cli_cmd_new_test_content
	movq %r13, %rdi
	movq %rax, %rsi
	callq _donna_files_write
	leaq _str64(%rip), %rsi
	...
	callq ___rt_str_concat
	movq %rax, %r13
	callq _cli_cmd_new_workflow_content
	movq %r13, %rdi
	movq %rax, %rsi
	callq _donna_files_write
	leaq _str68(%rip), %rsi
	...
	movq %rdi, %r13
	movq %rbx, %rdi
	callq _cli_cmd_new_readme_content
	movq %r13, %rdi
	movq %rax, %rsi
	callq _donna_files_write
	movq %r12, %rdi
	...
	callq ___rt_str_concat
	movq %rax, %r12
	callq _cli_cmd_new_gitignore_content
	movq %r12, %rdi
	movq %rax, %rsi
	callq _donna_files_write
	movq %rbx, %rdi
	callq _cli_cmd_new_success_message
	popq %r13
	popq %r12
	popq %rbx
	leave

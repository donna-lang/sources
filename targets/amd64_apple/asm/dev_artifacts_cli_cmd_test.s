...
_cli_cmd_test_qbe_missing_error:
	...
	callq _utilities_colors_dim
	movq %rax, %rbx
	leaq _str339(%rip), %rdi
	callq _utilities_colors_red
	movq %rbx, %rsi
	movq %rax, %rdi
	movq %rsi, %rbx
	leaq _str341(%rip), %rsi
	callq ___rt_str_concat
	movq %rbx, %rsi
	movq %rax, %rdi
	callq ___rt_str_concat

...
_cli_cmd_test_scrub_main_from_ssa:
	...
	movq %r14, %rsi
	movq %rax, %rdi
	leaq _str635(%rip), %rdx
	movq %rsi, %r14
	leaq _str634(%rip), %rsi
	callq _donna_string_replace
	movq %r15, %rdi
	movq %rax, %rsi
	movq %rsi, (%r13)

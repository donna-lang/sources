...
_cli_cmd_test_do_test:
	...
	movq %rax, %r15
	movq %r13, %rdi
	callq _builder_tester_collect_invalid_public_test_functions
	movq %rax, %rdi
	movq %rdi, -16(%rbp)
	movq %rdi, %rax
	callq _donna_list_is_empty
	...
	movq %r15, %rdi
	movq %rax, %rsi
	callq _cli_cmd_test_select_test_files
	movq %rax, -24(%rbp)
	movq %r12, %rdi
	...
	movq %rdi, %rbx
	movq %r14, %rdi
	callq _cli_cmd_test_write_if_changed
	movq %r15, %r9
	movq %r14, %r8
	movq %r13, %rcx
	movq %r12, %rsi
...
Lbb14:
	...
	movq %r15, %r12
	movq %r14, %rbx
	callq _cli_cmd_test_no_tests_error
	movq %rax, (%r13)
Lbb16:
	movq %rax, (%r12)
	jmp Lbb19
Lbb17:
	...
	movq %r13, %rbx
	movq %rax, %rdi
	callq _cli_cmd_test_invalid_test_names_error
	movq %rax, (%r12)
Lbb19:
	movq %rax, (%rbx)
	jmp Lbb24
...
_cli_cmd_test_build_and_run:
	...
	movq %rsi, %r13
	movq %r14, %rsi
	callq _builder_dependencies_resolve_dev_deps_checked
	movq %r14, %rdi
	subq $16, %rsp
	movq %rsp, %r14
	movq %r14, -56(%rbp)
	...
	movq %rdi, %r14
	movq %rbx, %rdi
	callq _cli_cmd_test_normalize_dev_deps
	movq %r14, %rdi
	movq %rax, -80(%rbp)
	movq -32(%rbp), %rsi
	movq %rsi, %r14
	...
	movq %rdi, %rbx
	movq %rax, %rdi
	callq _cli_cmd_test_source_pairs_for_tests
	movq %r13, %rsi
	movq %rax, %rdi
	movq -24(%rbp), %rcx
	movq -32(%rbp), %r13
	movq %r14, %rdx
	callq _builder_pipeline_compile_named_file_list
	movq %r13, %rsi
	movq %rbx, %rdi
	movq -88(%rbp), %rcx
	movq -56(%rbp), %rbx
	...
	movq -208(%rbp), %r14
	movq %rdi, %r15
	callq _cli_cmd_test_output_current
	movq %r15, %rdi
	movq %rax, %rcx
	movq -224(%rbp), %rax
	movq %rdi, %r15
	...
	movq %r15, %rdi
	movq %rdi, %r15
	callq _cli_cmd_test_maybe_codesign
	movq %r15, %rdi
	movq -224(%rbp), %r15
	callq _cli_cmd_test_run_test_binary
	movq -232(%rbp), %r9
	movq -240(%rbp), %r8
	movq -248(%rbp), %rdi
	movq -256(%rbp), %rsi
...
Lbb39:
	movq %rax, %r15
	callq _cli_cmd_test_linker_failed_error
	movq -232(%rbp), %r9
	movq -240(%rbp), %r8
	movq -248(%rbp), %rdi
	movq -256(%rbp), %rsi
...
.text
.balign 16
_cli_cmd_test_invalid_test_names_error:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
	pushq %rbx
	movq %rdi, %rbx
	leaq _str323(%rip), %rdi
	callq _utilities_colors_red
	movq %rax, %rdi
	leaq _str325(%rip), %rsi
	callq ___rt_str_concat
	movq %rbx, %rdi
	movq %rax, %rbx
	leaq _str327(%rip), %rsi
	callq _cli_cmd_test_invalid_test_lines
	movq %rbx, %rdi
	movq %rax, %rsi
	callq ___rt_str_concat
	popq %rbx
...
.text
.balign 16
_cli_cmd_test_invalid_test_lines:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	pushq %rbx
...
.text
.balign 16
_cli_cmd_test_no_tests_error:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
	pushq %rbx
	leaq _str351(%rip), %rdi
	callq _utilities_colors_red
	movq %rax, %rdi
...
_cli_cmd_test_qbe_missing_error:
	...
	subq $8, %rsp
	pushq %rbx
	leaq _str358(%rip), %rdi
	callq _utilities_colors_dim
	movq %rax, %rbx
	leaq _str360(%rip), %rdi
	callq _utilities_colors_red
	movq %rbx, %rsi
	movq %rax, %rdi
	movq %rsi, %rbx
...
_cli_cmd_test_c_compiler_missing_error:
	...
	subq $8, %rsp
	pushq %rbx
	leaq _str365(%rip), %rdi
	callq _utilities_colors_dim
	movq %rax, %rbx
	leaq _str367(%rip), %rdi
	callq _utilities_colors_red
	movq %rbx, %rsi
	movq %rax, %rdi
	movq %rsi, %rbx
	leaq _str369(%rip), %rsi
	callq ___rt_str_concat
	movq %rbx, %rsi
	movq %rax, %rdi
	callq ___rt_str_concat
...
.text
.balign 16
_cli_cmd_test_linker_failed_error:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
	...
	jz Lbb87
	movq %rdi, %rbx
	leaq _str391(%rip), %rdi
	callq _utilities_colors_dim
	movq %rbx, %rdi
	movq %rax, %rbx
	callq _cli_cmd_test_indent
	movq %rbx, %rdi
	movq %rax, %rsi
	callq ___rt_str_concat
	movq %rax, %r15
...
Lbb88:
	...
	leave
	ret
/* end function cli_cmd_test_linker_failed_error */

.text
.balign 16
_cli_cmd_test_indent:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	leaq _str414(%rip), %rsi
	callq _donna_string_split
	movq %rax, %rdi
	leaq _str416(%rip), %rsi
	callq _cli_cmd_test_indent_lines
	leave
	ret
/* end function cli_cmd_test_indent */

.text
.balign 16
_cli_cmd_test_indent_lines:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	pushq %rbx
...
Lbb94:
	...
	leave
	ret
/* end function cli_cmd_test_indent_lines */

.text
.balign 16
_cli_cmd_test_normalize_dev_deps:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
	...
	movq %rax, %rdi
	callq _cli_cmd_test_remove_dep_named
Lbb97:
	popq %rbx
	leave
	ret
/* end function cli_cmd_test_normalize_dev_deps */

.text
.balign 16
_cli_cmd_test_remove_dep_named:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
...
Lbb105:
	...
	leave
	ret
/* end function cli_cmd_test_remove_dep_named */

.text
.balign 16
_cli_cmd_test_select_test_files:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	leaq _donna_nil(%rip), %rdx
	callq _cli_cmd_test_select_test_files_loop
	leave
	ret
/* end function cli_cmd_test_select_test_files */

.text
.balign 16
_cli_cmd_test_select_test_files_loop:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
	...
	movq %rdi, %rbx
	movq %r14, %rdi
	callq _cli_cmd_test_selected_has_module
	movq %r14, %rsi
	movq %rbx, %rdi
	subq $16, %rsp
	movq %rsp, %rbx
...
Lbb115:
	...
	leave
	ret
/* end function cli_cmd_test_select_test_files_loop */

.text
.balign 16
_cli_cmd_test_selected_has_module:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	pushq %rbx
...
Lbb122:
	...
	leave
	ret
/* end function cli_cmd_test_selected_has_module */

.text
.balign 16
_cli_cmd_test_source_pairs_for_tests:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	pushq %rbx
	...
	movq %rsi, %rbx
	leaq _donna_nil(%rip), %rdx
	leaq _str521(%rip), %rsi
	callq _cli_cmd_test_collect_source_pairs
	movq %rbx, %rdi
	movq %rax, %rbx
	leaq _donna_nil(%rip), %rsi
	movq %rdi, %r12
	movq %rbx, %rdi
	callq _cli_cmd_test_pair_names
	movq %r12, %rdi
	movq %rax, %rdx
	movq %rdx, %r12
	leaq _donna_nil(%rip), %rdx
	movq %r12, %rsi
	callq _cli_cmd_test_test_imports
	movq %r12, %rdx
	movq %rax, %rdi
	leaq _donna_nil(%rip), %rcx
	movq %rbx, %rsi
	callq _cli_cmd_test_expand_needed_modules
	movq %rbx, %rdi
	movq %rax, %rsi
	leaq _donna_nil(%rip), %rdx
	callq _cli_cmd_test_filter_pairs_by_names
	popq %r12
	popq %rbx
	leave
	ret
/* end function cli_cmd_test_source_pairs_for_tests */

.text
.balign 16
_cli_cmd_test_collect_source_pairs:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
	...
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _cli_cmd_test_collect_source_pairs_loop
	popq %r13
	popq %r12
	popq %rbx
	leave
	ret
/* end function cli_cmd_test_collect_source_pairs */

.text
.balign 16
_cli_cmd_test_collect_source_pairs_loop:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $72, %rsp
...
Lbb150:
	...
	leave
	ret
/* end function cli_cmd_test_collect_source_pairs_loop */

.text
.balign 16
_cli_cmd_test_pair_names:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
...
Lbb155:
	...
	leave
	ret
/* end function cli_cmd_test_pair_names */

.text
.balign 16
_cli_cmd_test_test_imports:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
	...
	movq %rax, %rdx
	movq %rsi, %r12
	callq _cli_cmd_test_import_lines
	movq %r12, %rsi
	movq %rbx, %rdi
	movq %rax, %rdx
	callq _cli_cmd_test_test_imports
...
Lbb159:
	...
	leave
	ret
/* end function cli_cmd_test_test_imports */

.text
.balign 16
_cli_cmd_test_import_lines:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	pushq %rbx
	...
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _cli_cmd_test_import_line_loop
	popq %r12
	popq %rbx
	leave
	ret
/* end function cli_cmd_test_import_lines */

.text
.balign 16
_cli_cmd_test_import_line_loop:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $24, %rsp
	...
	movq %rax, %rdi
	callq _cli_cmd_test_import_path_only
	movq %r14, %rsi
	movq %rax, %rdi
	movq %rsi, %r15
	callq _cli_cmd_test_local_dep_name
	movq %r13, %rdi
	movq %rax, %r13
	movq %rdi, %r14
	movq %r13, %rdi
...
Lbb172:
	...
	leave
	ret
/* end function cli_cmd_test_import_line_loop */

.text
.balign 16
_cli_cmd_test_expand_needed_modules:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $24, %rsp
	...
	movq %rdi, %rbx
	movq %r14, %rdi
	callq _cli_cmd_test_path_for_module
	movq %rax, %rdi
	callq _donna_files_read
	movq %r15, %rdx
	movq %r14, %rsi
...
Lbb179:
	...
	leave
	ret
/* end function cli_cmd_test_expand_needed_modules */

.text
.balign 16
_cli_cmd_test_path_for_module:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
...
Lbb185:
	...
	leave
	ret
/* end function cli_cmd_test_path_for_module */

.text
.balign 16
_cli_cmd_test_filter_pairs_by_names:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $24, %rsp
...
Lbb193:
	...
	leave
	ret
/* end function cli_cmd_test_filter_pairs_by_names */

.text
.balign 16
_cli_cmd_test_import_path_only:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
...
Lbb197:
	...
	leave
	ret
/* end function cli_cmd_test_import_path_only */

.text
.balign 16
_cli_cmd_test_local_dep_name:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	pushq %rbx
	...
	movq %rdi, %rbx
	movq %rax, %rdi
	callq _cli_cmd_test_path_last_segment
	movq %rbx, %rdi
	movq %rax, %rsi
	callq _cli_cmd_test_find_local_dep_by_last_segment
Lbb200:
	popq %r12
	popq %rbx
	leave
	ret
/* end function cli_cmd_test_local_dep_name */

.text
.balign 16
_cli_cmd_test_find_local_dep_by_last_segment:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
...
Lbb206:
	...
	leave
	ret
/* end function cli_cmd_test_find_local_dep_by_last_segment */

.text
.balign 16
_cli_cmd_test_path_last_segment:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	leaq _str793(%rip), %rsi
	callq _donna_string_split
	movq %rax, %rdi
	leaq _str795(%rip), %rsi
	callq _cli_cmd_test_path_last_segment_loop
	leave
	ret
/* end function cli_cmd_test_path_last_segment */

.text
.balign 16
_cli_cmd_test_path_last_segment_loop:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	movq %rsi, %rax
...
Lbb211:
	leave
	ret
/* end function cli_cmd_test_path_last_segment_loop */
...
_cli_cmd_test_compile_deps:
	...
	movq %rax, %rdi
	movq %rdi, -8(%rbp)
	leaq _str870(%rip), %rsi
	callq _donna_files_join
	movq %rbx, %rdi
	movq %rax, %rsi
	movq %rsi, %r13
	leaq _str872(%rip), %rsi
	movq %rdi, %rbx
	movq %r12, %rdi
	callq _donna_files_join
	movq %rax, %rdi
...
_cli_cmd_test_maybe_codesign:
	...
	cmpq $0, %rax
	jz Lbb262
	leaq _str1061(%rip), %rdi
	callq ___rt_str_concat
	movq %rax, %rdi
	leaq _str1063(%rip), %rsi
	callq ___rt_str_concat
	movq %rax, %rdi
	callq _donna_shell_run
	jmp Lbb263
...
_cli_cmd_test_run_test_binary:
	...
	pushq %rbx
	movq %rdi, %rbx
	callq _utilities_logger_running_tests
	...
	jz Lbb266
	callq _exit
	leaq _str1076(%rip), %rax
	jmp Lbb267
Lbb266:
	leaq _str1075(%rip), %rax
Lbb267:
	popq %rbx
	leave
	ret
/* end function cli_cmd_test_run_test_binary */

.text
.balign 16
_cli_cmd_test_output_current:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	pushq %rbx
	...
	cmpq $0, %rax
	jz Lbb270
	callq _cli_cmd_test_inputs_older_than_output
	jmp Lbb271
Lbb270:
	movl $0, %eax
Lbb271:
	...
	leave
	ret
/* end function cli_cmd_test_output_current */

.text
.balign 16
_cli_cmd_test_inputs_older_than_output:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	subq $8, %rsp
...
Lbb278:
	...
	leave
	ret
/* end function cli_cmd_test_inputs_older_than_output */

.text
.balign 16
_cli_cmd_test_sh_quote:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	leaq _str1115(%rip), %rdx
	leaq _str1114(%rip), %rsi
	callq _donna_string_replace
	movq %rax, %rsi
	leaq _str1113(%rip), %rdi
	callq ___rt_str_concat
	movq %rax, %rdi
	leaq _str1118(%rip), %rsi
	callq ___rt_str_concat
	leave
	ret
/* end function cli_cmd_test_sh_quote */
...
_cli_cmd_test_scrub_main_from_ssa:
	...
	movq %rax, %rsi
	movq %rsi, %r15
	leaq _str1132(%rip), %rsi
	movq %rdi, %r13
	movq %r15, %rdi
	callq _donna_string_contains
	movq %r15, %rsi
	movq %r13, %rdi
	movq %rax, -16(%rbp)
	movq %rsi, %r15
	...
	movq %r14, %rsi
	movq %rax, %rdi
	leaq _str1146(%rip), %rdx
	movq %rsi, %r14
	leaq _str1145(%rip), %rsi
	callq _donna_string_replace
	movq %r15, %rdi
	movq %rax, %rsi
	movq %rsi, (%r13)
...
.text
.balign 16
_cli_cmd_test_write_if_changed:
	endbr64
	pushq %rbp
	movq %rsp, %rbp
	pushq %rbx
...
Lbb296:
	...
	leave
	ret
/* end function cli_cmd_test_write_if_changed */

...
Lbb78:
	...
	movq 16(%rbx), %rdi
	movq 8(%rax), %rsi
	callq _compiler_parser_parse_patterns_parse_list_pattern
	jmp Lbb138
Lbb79:
	movq 8(%rbx), %rcx
	movq 16(%rbx), %rax
...
Lbb92:
	...
	callq _compiler_parser_parse_patterns_parse_paren_patterns
	movq %r12, %rsi
	subq $16, %rsp
	movq %rsp, %r12
	movq (%rax), %rcx
	...
	movq 8(%rax), %rdi
	movq 16(%rax), %r13
	callq _compiler_parser_ast_PTuple
	movq %r13, %rsi
	movq %rax, %rdi
...
Lbb104:
	...
	jnz Lbb106
	movq %rcx, %rsi
	callq _compiler_parser_ast_PVar
	movq %rax, %rdi
	movq %r12, %rsi
	callq _compiler_parser_parse_result_POk
	movq %rax, (%rbx)
...
Lbb129:
	...
	movq 8(%rax), %rsi
	movl $0, %edi
	callq _compiler_parser_ast_PBool
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb138
...
Lbb131:
	...
	movq %rsi, %rbx
	movq 8(%rax), %rsi
	callq _compiler_parser_ast_PString
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb138
Lbb132:
	...
	movq %rsi, %rbx
	movq 8(%rax), %rsi
	callq _compiler_parser_ast_PFloat
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb138
Lbb133:
	...
	movq %r12, %rsi
	movq %rax, %rdi
	callq _compiler_parser_ast_PInt
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb138
...
Lbb135:
	...
	movq %rsi, %rbx
	movq 8(%rax), %rsi
	callq _compiler_parser_ast_PDiscard
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb138
Lbb136:
	...
	movq 16(%rbx), %rbx
	movq 8(%rax), %rdi
	callq _compiler_parser_ast_PWild
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
	jmp Lbb138
...
_compiler_parser_parse_patterns_parse_paren_patterns:
	...
	callq _compiler_parser_parse_result_skip_newlines
	movq %rax, %rdi
	callq _compiler_parser_parse_patterns_strip_pattern_label
	movq %rbx, %rdi
	movq (%rax), %rcx
	cmpq $1, %rcx
	setz %cl
...
Lbb182:
	...
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_patterns_parse_list_elems
	jmp Lbb185
Lbb184:
	movq 16(%rax), %rsi
	movq %rsi, %rbx
	...
	callq _compiler_parser_ast_PList
	movq %rbx, %rsi
	movq %rax, %rdi
	callq _compiler_parser_parse_result_POk
Lbb185:
...
Lbb219:
	...
	movq %rax, %rdx
	movq %rsi, %r13
	callq _compiler_parser_parse_patterns_parse_list_spread
	movq %rax, (%rbx)
	jmp Lbb228
Lbb221:
	movq %rsi, %r13

...
cli_cmd_format_run:
	...
	mov	x29, sp
	str	x19, [x29, 24]
	bl	cli_cmd_format_first_positional
	adrp	x1, str1
	add	x1, x1, #:lo12:str1
	mov	x19, x0
	...
	cmp	x1, #1
	beq	.L2
	bl	cli_cmd_format_format_project
	b	.L3
.L2:
	bl	cli_cmd_format_format_file
.L3:
	ldr	x19, [x29, 24]
	ldp	x29, x30, [sp], 32
	ret
...
cli_cmd_format_format_project:
	...
	bl	cli_cmd_format_find_donna_files
	mov	x1, #0
	bl	cli_cmd_format_format_files
	mov	x19, x0
	bl	donna_time_now_us
	sub	x0, x0, x20
	bl	utilities_logger_fmt_ok
	mov	x0, x19
	cmp	x0, #0
	cset	x1, eq
	mov	x2, #16
...
cli_cmd_format_find_donna_files:
	...
	mov	x2, x20
	mov	x1, x19
	bl	cli_cmd_format_collect_entries
	ldr	x19, [x29, 24]
	ldr	x20, [x29, 16]
	ldp	x29, x30, [sp], 32
	ret
...
cli_cmd_format_format_one:
	...
	mov	x20, x1
	mov	x19, x0
	bl	tools_fmt_formatter_format_source
	mov	x1, x0
	mov	x0, x19
	ldr	x2, [x1]
	cmp	x2, #1
	...
	mov	x1, x20
	mov	x0, x1
	bl	cli_cmd_format_path_to_module
	bl	utilities_logger_formatting
	mov	x0, #1
	str	x0, [x19]
	mov	x0, #1
	b	.L44

...
.L78:
	...
	add	x1, x1, x2
	ldr	x1, [x1]
	bl	compiler_parser_parse_patterns_parse_list_pattern
	b	.L139
.L79:
	mov	x0, #8
	add	x0, x19, x0
...
.L92:
	...
	bl	compiler_parser_parse_patterns_parse_paren_patterns
	mov	x1, x20
	mov	x2, #16
	sub	sp, sp, x2
	mov	x20, sp
...
.L132:
	...
	add	x1, x1, x2
	ldr	x1, [x1]
	bl	compiler_parser_ast_PString
	mov	x1, x19
	bl	compiler_parser_parse_result_POk
	b	.L139
.L133:
...
.L136:
	...
	add	x1, x1, x2
	ldr	x1, [x1]
	bl	compiler_parser_ast_PDiscard
	mov	x1, x19
	bl	compiler_parser_parse_result_POk
	b	.L139
.L137:
...
compiler_parser_parse_patterns_parse_paren_patterns:
	...
	mov	x19, x1
	bl	compiler_parser_parse_result_skip_newlines
	bl	compiler_parser_parse_patterns_strip_pattern_label
	mov	x1, x0
	mov	x0, x19
	ldr	x2, [x1]
	cmp	x2, #1
...
.L184:
	...
	add	x2, x2, #:lo12:donna_nil
	mov	x1, x19
	bl	compiler_parser_parse_patterns_parse_list_elems
	b	.L187
.L186:
	mov	x1, #16
	add	x0, x0, x1
...
.L222:
	...
	mov	x0, x20
	mov	x21, x1
	bl	compiler_parser_parse_patterns_parse_list_spread
	str	x0, [x19]
	b	.L230
.L223:
	mov	x21, x1

...
builder_semver_parse_constraints:
	...
	stp	x29, x30, [sp, -16]!
	mov	x29, sp
	bl	builder_semver_split_and
	adrp	x1, donna_nil
	add	x1, x1, #:lo12:donna_nil
	bl	builder_semver_collect_constraints
	ldp	x29, x30, [sp], 16
	ret
...
builder_semver_satisfies:
	...
	ldr	x20, [x2]
	mov	x19, x0
	bl	builder_semver_satisfies_one
	mov	x1, x20
	mov	x2, x0
	mov	x0, x19
	mov	x3, #16
...
builder_semver_parse_nat:
	...
	mov	x3, #0
	mov	x1, #0
	bl	builder_semver_parse_nat_loop
	ldr	x19, [x29, 24]
	ldp	x29, x30, [sp], 32
	ret

...
.L24:
	...
	bne	.L26
	adrp	x0, str533
	add	x0, x0, #:lo12:str533
	bl	utilities_location_zero
	mov	x1, x0
	adrp	x0, str532
	add	x0, x0, #:lo12:str532
...
.L77:
	...
	add	x2, x2, x3
	ldr	x21, [x2]
	bl	compiler_parser_ast_TyTuple
	mov	x1, x21
	bl	compiler_parser_parse_result_POk
	str	x0, [x20]
	b	.L81

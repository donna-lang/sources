...
L19:
	...
	mov	x1, x0
	mov	x0, x21
	bl	_compiler_parser_ast_ExprStmt
	mov	x1, x20
...
L67:
	cmp	w2, #0
	bne	L69
	adrp	x0, _str367@page
	add	x0, x0, _str367@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x20]
	b	L75
...
L70:
	...
	ldr	x22, [x2]
	mov	x2, x23
	bl	_compiler_parser_ast_LetPatStmt
	mov	x1, x22
	bl	_compiler_parser_parse_result_POk
	str	x0, [x21]
	b	L74
...
L79:
	...
	add	x0, x0, x2
	ldr	x0, [x0]
	adrp	x2, _str247@page
	add	x2, x2, _str247@pageoff
	bl	_compiler_parser_parse_exprs_parse_let_name
	b	L81
L80:
	mov	x2, #8
...
L96:
	...
	bne	L98
	mov	x1, x20
	adrp	x0, _str564@page
	add	x0, x0, _str564@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	b	L125
L98:
...
L99:
	...
	mov	x23, x0
	bl	_compiler_parser_ast_LetStmt
	mov	x1, x20
	bl	_compiler_parser_parse_result_POk
	str	x0, [x19]
	b	L125
...
L115:
	...
	bne	L117
	mov	x1, x25
	adrp	x0, _str489@page
	add	x0, x0, _str489@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x20]
	b	L123
...
L150:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BOr@page
	add	x0, x0, _compiler_parser_ast_BOr@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_or_loop
	str	x0, [x19]
...
L163:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BAnd@page
	add	x0, x0, _compiler_parser_ast_BAnd@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_and_loop
...
L261:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BConcat@page
	add	x0, x0, _compiler_parser_ast_BConcat@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_concat_loop
...
L289:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BSubDot@page
	add	x0, x0, _compiler_parser_ast_BSubDot@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_add_loop
...
L292:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BAddDot@page
	add	x0, x0, _compiler_parser_ast_BAddDot@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_add_loop
...
L295:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BSub@page
	add	x0, x0, _compiler_parser_ast_BSub@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_add_loop
...
L298:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BAdd@page
	add	x0, x0, _compiler_parser_ast_BAdd@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_add_loop
...
L331:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BDivDot@page
	add	x0, x0, _compiler_parser_ast_BDivDot@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_mul_loop
...
L334:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BMulDot@page
	add	x0, x0, _compiler_parser_ast_BMulDot@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_mul_loop
...
L337:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BMod@page
	add	x0, x0, _compiler_parser_ast_BMod@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_mul_loop
...
L340:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BDiv@page
	add	x0, x0, _compiler_parser_ast_BDiv@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_mul_loop
...
L343:
	...
	ldr	x0, [x0]
	mov	x20, x0
	adrp	x0, _compiler_parser_ast_BMul@page
	add	x0, x0, _compiler_parser_ast_BMul@pageoff
	bl	_compiler_parser_ast_BinOp
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_parser_parse_exprs_parse_mul_loop
...
L357:
	...
	bl	_compiler_parser_ast_UnaryOp
	mov	x1, x20
	bl	_compiler_parser_parse_result_POk
	str	x0, [x19]
	b	L363
...
L391:
	...
	add	x2, x2, x3
	ldr	x2, [x2]
	bl	_compiler_parser_ast_FieldAccess
	mov	x1, x0
	mov	x0, x19
	bl	_compiler_parser_parse_exprs_parse_call_loop
	b	L398
...
L419:
	cmp	w1, #0
	bne	L421
	adrp	x0, _str2129@page
	add	x0, x0, _str2129@pageoff
	bl	_utilities_location_zero
	mov	x1, x0
	adrp	x0, _str2128@page
	add	x0, x0, _str2128@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x20]
	b	L426
L421:
	...
	bl	_compiler_lexer_token_to_string
	mov	x2, x21
	adrp	x1, _str2125@page
	add	x1, x1, _str2125@pageoff
	bl	_errors_error_ParseUnexpectedToken
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x20]
	b	L426
...
L535:
	cmp	w1, #0
	bne	L537
	adrp	x0, _str2840@page
	add	x0, x0, _str2840@pageoff
	bl	_utilities_location_zero
	mov	x1, x0
	adrp	x0, _str2839@page
	add	x0, x0, _str2839@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	b	L574
L537:
	...
	bl	_compiler_lexer_token_to_string
	mov	x2, x19
	adrp	x1, _str2836@page
	add	x1, x1, _str2836@pageoff
	bl	_errors_error_ParseUnexpectedToken
	bl	_compiler_parser_parse_result_PErr
	b	L574
L538:
...
L551:
	cmp	w0, #0
	bne	L553
	adrp	x0, _str2726@page
	add	x0, x0, _str2726@pageoff
	bl	_utilities_location_zero
	mov	x1, x0
	adrp	x0, _str2725@page
	add	x0, x0, _str2725@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x20]
	b	L556
L553:
	...
	bl	_compiler_lexer_token_to_string
	mov	x2, x21
	adrp	x1, _str2722@page
	add	x1, x1, _str2722@pageoff
	bl	_errors_error_ParseUnexpectedToken
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x20]
	b	L556
...
L569:
	...
	ldr	x1, [x0]
	mov	x0, #0
	bl	_compiler_parser_ast_BoolLit
	mov	x1, x19
	bl	_compiler_parser_parse_result_POk
	b	L574
L570:
...
L571:
	...
	add	x1, x1, x2
	ldr	x1, [x1]
	bl	_compiler_parser_ast_StringLit
	mov	x1, x19
	bl	_compiler_parser_parse_result_POk
	b	L574
L572:
	...
	add	x1, x1, x2
	ldr	x1, [x1]
	bl	_compiler_parser_ast_FloatLit
	mov	x1, x19
	bl	_compiler_parser_parse_result_POk
	b	L574
L573:
	...
	add	x1, x1, x2
	ldr	x1, [x1]
	bl	_compiler_parser_ast_IntLit
	mov	x1, x19
	bl	_compiler_parser_parse_result_POk
L574:
	ldr	x19, [x29, 40]
...
L600:
	...
	bl	_compiler_lexer_token_to_string
	mov	x2, x20
	adrp	x1, _str2980@page
	add	x1, x1, _str2980@pageoff
	bl	_errors_error_ParseUnexpectedToken
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L606
...
L645:
	cmp	w0, #0
	bne	L647
	adrp	x0, _str3209@page
	add	x0, x0, _str3209@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L655
L647:
	...
	bl	_compiler_lexer_token_to_string
	mov	x2, x20
	adrp	x1, _str3206@page
	add	x1, x1, _str3206@pageoff
	bl	_errors_error_ParseUnexpectedToken
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L655
...
L667:
	...
	bne	L669
	mov	x1, x2
	adrp	x0, _str3285@page
	add	x0, x0, _str3285@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L674
L669:
	...
	bl	_compiler_lexer_token_to_string
	mov	x2, x20
	adrp	x1, _str3282@page
	add	x1, x1, _str3282@pageoff
	bl	_errors_error_ParseUnexpectedToken
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L674
L670:
	...
	add	x3, x3, x4
	ldr	x20, [x3]
	bl	_compiler_parser_ast_ListSpread
	mov	x1, x20
	bl	_compiler_parser_parse_result_POk
	str	x0, [x19]
	b	L674
...
L686:
	...
	bne	L688
	mov	x1, x20
	adrp	x0, _str3422@page
	add	x0, x0, _str3422@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L707
L688:
	...
	add	x0, x0, x1
	ldr	x0, [x0]
	bl	_errors_error_ParseMissingColon
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L707
L689:
...
L738:
	cmp	w0, #0
	bne	L740
	adrp	x0, _str3564@page
	add	x0, x0, _str3564@pageoff
	bl	_utilities_location_zero
	mov	x1, x0
	adrp	x0, _str3563@page
	add	x0, x0, _str3563@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x21]
	b	L741
L740:
	...
	bl	_compiler_lexer_token_to_string
	mov	x2, x22
	adrp	x1, _str3560@page
	add	x1, x1, _str3560@pageoff
	bl	_errors_error_ParseUnexpectedToken
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x21]
L741:
...
L829:
	...
	bne	L831
	mov	x1, x21
	adrp	x0, _str4109@page
	add	x0, x0, _str4109@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L861
L831:
	...
	add	x0, x0, x1
	ldr	x0, [x0]
	bl	_errors_error_ParseMissingArrow
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L861
L832:
	...
	adrp	x1, _donna_option_None@page
	add	x1, x1, _donna_option_None@pageoff
	bl	_compiler_parser_ast_CaseClause
	mov	x1, x21
	bl	_compiler_parser_parse_result_POk
	str	x0, [x20]
	b	L836
...
L849:
	...
	bne	L851
	mov	x1, x26
	adrp	x0, _str4036@page
	add	x0, x0, _str4036@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x21]
	b	L857
...
L884:
	...
	bne	L886
	mov	x1, x21
	adrp	x0, _str4255@page
	add	x0, x0, _str4255@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L894
...
L887:
	...
	add	x3, x3, x4
	ldr	x21, [x3]
	bl	_compiler_parser_ast_Lambda
	mov	x1, x21
	bl	_compiler_parser_parse_result_POk
	str	x0, [x20]
	b	L892

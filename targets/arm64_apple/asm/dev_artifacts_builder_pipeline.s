...
_builder_pipeline_c_compiler_command:
	...
	cmp	x0, #1
	beq	L68
	adrp	x0, _str241@page
	add	x0, x0, _str241@pageoff
	bl	_donna_shell_run
	cmp	x0, #0
	cset	x0, eq
	mov	x1, #16
...
L67:
	...
	b	L70
L68:
	adrp	x0, _str240@page
	add	x0, x0, _str240@pageoff
	str	x0, [x19]
	adrp	x0, _str240@page
	add	x0, x0, _str240@pageoff
L70:
...
_builder_pipeline_compile_c:
	...
	mov	x2, #8
	add	x3, x21, x2
	adrp	x2, _str333@page
	add	x2, x2, _str333@pageoff
	str	x2, [x3]
	mov	x22, x1
	mov	x1, #16
	add	x1, x21, x1
	...
	mov	x2, #8
	add	x3, x0, x2
	adrp	x2, _str344@page
	add	x2, x2, _str344@pageoff
	str	x2, [x3]
	mov	x20, x1
	mov	x1, #16
	add	x1, x0, x1
...
_builder_pipeline_mod_name_to_stem:
	...
	stp	x29, x30, [sp, -16]!
	mov	x29, sp
	adrp	x2, _str405@page
	add	x2, x2, _str405@pageoff
...
_builder_pipeline_file_is_current:
	...
	mov	x0, x19
	mov	x19, x0
	adrp	x0, _str413@page
	add	x0, x0, _str413@pageoff
	bl	___rt_str_concat
	adrp	x1, _str416@page
	add	x1, x1, _str416@pageoff
	bl	___rt_str_concat
	mov	x17, x0
	mov	x0, x19
	mov	x19, x17
...
_builder_pipeline_sh_quote:
	...
	stp	x29, x30, [sp, -16]!
	mov	x29, sp
	adrp	x2, _str425@page
	add	x2, x2, _str425@pageoff
	adrp	x1, _str424@page
	add	x1, x1, _str424@pageoff
	bl	_donna_string_replace
	mov	x1, x0
...
_builder_pipeline_collect_donna:
	...
	ldr	x0, [x0]
	mov	x22, x1
	adrp	x1, _str496@page
	add	x1, x1, _str496@pageoff
	mov	x19, x0
	mov	x0, x21
	bl	_donna_string_ends_with
	mov	x1, x22
...
_builder_pipeline_collect_pairs_recursive:
	...
	mov	x0, x19
	mov	x23, x1
	adrp	x1, _str523@page
	add	x1, x1, _str523@pageoff
	mov	x19, x0
	bl	_donna_string_ends_with
	mov	x2, x20
	mov	x1, x0
...
L154:
	...
	beq	L157
	mov	x25, x1
	adrp	x1, _str537@page
	add	x1, x1, _str537@pageoff
	mov	x22, x0
	mov	x0, x24
	bl	___rt_str_concat
	mov	x1, x25
...
L202:
	...
	b	L204
L203:
	adrp	x0, _str709@page
	add	x0, x0, _str709@pageoff
L204:
	ldr	x19, [x29, 40]
	ldr	x20, [x29, 32]
	ldr	x21, [x29, 24]
...
_builder_pipeline_path_last_segment:
	...
	stp	x29, x30, [sp, -16]!
	mov	x29, sp
	adrp	x1, _str724@page
	add	x1, x1, _str724@pageoff
	bl	_donna_string_split
	adrp	x1, _str726@page
	add	x1, x1, _str726@pageoff
...
_builder_pipeline_count_import_lines:
	...
	add	x1, x1, x2
	ldr	x19, [x1]
	adrp	x1, _str939@page
	add	x1, x1, _str939@pageoff
	bl	_donna_string_starts_with
	mov	x1, x0
	mov	x0, x19
	mov	x2, #16

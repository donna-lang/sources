...
_compiler_codegen_codegen_add_data_def:
	...
	mov	x20, x1
	mov	x19, x0
	bl	_compiler_codegen_codegen_state_data_defs
	mov	x17, x0
	mov	x0, x19
	mov	x19, x17
	mov	x21, x0
	...
	add	x2, x1, x2
	str	x19, [x2]
	bl	_compiler_codegen_codegen_set_data_defs
	ldr	x19, [x29, 40]
	ldr	x20, [x29, 32]
	ldr	x21, [x29, 24]
	ldp	x29, x30, [sp], 48
...
_compiler_codegen_codegen_fresh_temp:
	...
	str	x20, [x29, 16]
	mov	x19, x0
	bl	_compiler_codegen_codegen_state_counter
	mov	x17, x0
	mov	x0, x19
	mov	x19, x17
	mov	x20, x0
	...
	mov	x1, #1
	add	x1, x19, x1
	bl	_compiler_codegen_codegen_set_counter
	mov	x19, x0
	mov	x0, #16
	bl	_malloc
	str	x20, [x0]
...
_compiler_codegen_codegen_intern_string:
	...
	mov	x0, x23
	mov	x23, x17
	adrp	x1, _compiler_codegen_il_Byte@page
	add	x1, x1, _compiler_codegen_il_Byte@pageoff
	str	x1, [x23]
	mov	x1, #8
	add	x1, x23, x1
	str	x19, [x1]
...
_compiler_codegen_codegen_block_jumps:
	...
	bl	_compiler_codegen_il_Volatile
	mov	x1, x0
	mov	x0, x19
	bl	_compiler_codegen_codegen_list_last_default
	bl	_compiler_codegen_codegen_is_terminal_stmt
	ldr	x19, [x29, 24]
	ldr	x20, [x29, 16]
	ldp	x29, x30, [sp], 32
	ret
...
_compiler_codegen_codegen_ensure_string_concat_helper:
	...
	adrp	x0, _compiler_codegen_il_Private@page
	add	x0, x0, _compiler_codegen_il_Private@pageoff
	bl	_compiler_codegen_il_Function
	mov	x20, x0
	mov	x0, x19
	mov	x19, x0
	bl	_compiler_codegen_codegen_state_helper_fns
	mov	x17, x0
	mov	x0, x19
	mov	x19, x17
	mov	x21, x0
	...
	add	x2, x1, x2
	str	x19, [x2]
	bl	_compiler_codegen_codegen_set_helper_fns
	mov	x19, x0
	bl	_compiler_codegen_codegen_state_emitted_helpers
	mov	x17, x0
	mov	x0, x19
...
_compiler_codegen_codegen_ensure_int_to_string_helper:
	...
	bl	_malloc
	mov	x21, x0
	adrp	x0, _compiler_codegen_il_Byte@page
	add	x0, x0, _compiler_codegen_il_Byte@pageoff
	str	x0, [x21]
	mov	x0, #8
	add	x0, x21, x0
	str	x20, [x0]
	...
	add	x3, x3, _donna_nil@pageoff
	str	x3, [x4]
	bl	_compiler_codegen_il_VaCall
	mov	x1, x0
	mov	x0, x20
	bl	_compiler_codegen_il_volatile_inst
	mov	x20, x0
...
_compiler_codegen_codegen_generate:
	...
	add	x1, x1, x2
	ldr	x23, [x1]
	bl	_compiler_codegen_codegen_module_qbe_prefix
	mov	x22, x0
	adrp	x1, _donna_nil@page
	add	x1, x1, _donna_nil@pageoff
	mov	x0, x21
	...
	str	x0, [x29, 16]
	bl	_compiler_codegen_codegen_new_state
	mov	x1, x23
	mov	x23, x1
	mov	x1, x22
	bl	_compiler_codegen_codegen_set_fn_prefix
	mov	x1, x23
	ldr	x23, [x29, 16]
	bl	_compiler_codegen_codegen_set_local_fn_names
	mov	x1, x26
	bl	_compiler_codegen_codegen_set_ctor_tags
	mov	x1, x25
	bl	_compiler_codegen_codegen_set_ctor_field_types
	mov	x1, x24
	bl	_compiler_codegen_codegen_set_globals
	mov	x1, x23
	bl	_compiler_codegen_codegen_set_extern_aliases
	mov	x1, x22
	mov	x2, x0
	mov	x0, x21
	adrp	x3, _donna_nil@page
	...
	bl	_donna_list_append
	mov	x1, x19
	bl	_compiler_codegen_il_ILModule
	bl	_compiler_codegen_il_display_module
	ldr	x19, [x29, 88]
	ldr	x20, [x29, 80]
	ldr	x21, [x29, 72]
	ldr	x22, [x29, 64]
...
_compiler_codegen_codegen_gen_type_defs:
	...
	ldr	x19, [x3]
	mov	x20, x1
	bl	_compiler_codegen_codegen_gen_type_def
	mov	x3, x21
	mov	x1, x20
	mov	x2, x0
	mov	x0, x19
...
_compiler_codegen_codegen_register_ctors:
	...
	bl	_compiler_codegen_codegen_set_ctor_tags
	mov	x20, x0
	bl	_compiler_codegen_codegen_state_ctor_field_types
	mov	x17, x0
	mov	x0, x20
	mov	x20, x17
	mov	x21, x0
...
_compiler_codegen_codegen_gen_constructors:
	...
	ldr	x19, [x3]
	mov	x20, x1
	bl	_compiler_codegen_codegen_gen_constructor
	mov	x3, x21
	mov	x1, x20
	mov	x2, x0
	mov	x0, x19
...
L178:
	...
	mov	x22, x1
	mov	x20, x0
	adrp	x0, _compiler_codegen_il_Public@page
	add	x0, x0, _compiler_codegen_il_Public@pageoff
	bl	_compiler_codegen_il_Function
	mov	x1, x21
	mov	x17, x0
	mov	x0, x20
...
L220:
	...
	mov	x20, x0
	mov	x0, x23
	bl	_compiler_codegen_codegen_block_jumps
	mov	x2, x25
	mov	x1, x24
	mov	x3, x0
	mov	x0, x20
...
_compiler_codegen_codegen_gen_constants:
	...
	ldr	x19, [x3]
	mov	x20, x1
	bl	_compiler_codegen_codegen_gen_constant
	mov	x1, x20
	mov	x2, x0
	mov	x0, x19
	bl	_compiler_codegen_codegen_gen_constants
...
L251:
	...
	add	x0, x22, x0
	ldr	x0, [x0]
	bl	_compiler_codegen_il_FloatConst
	mov	x22, x0
	mov	x0, x21
	mov	x21, x0
	mov	x0, #16
	...
	mov	x0, x21
	mov	x21, x17
	adrp	x2, _compiler_codegen_il_Double@page
	add	x2, x2, _compiler_codegen_il_Double@pageoff
	str	x2, [x21]
	mov	x23, x1
	mov	x1, #8
	add	x1, x21, x1
...
L259:
	...
	mov	x0, x23
	mov	x23, x17
	adrp	x2, _compiler_codegen_il_Byte@page
	add	x2, x2, _compiler_codegen_il_Byte@pageoff
	str	x2, [x23]
	mov	x24, x1
	mov	x1, #8
	add	x1, x23, x1
...
L303:
	...
	add	x2, x2, x3
	ldr	x23, [x2]
	bl	_compiler_codegen_codegen_intern_string_nl
	mov	x1, x0
	ldr	x0, [x1]
	mov	x2, #8
	add	x1, x1, x2
...
L319:
	...
	ldr	x0, [x29, 72]
	mov	x2, x25
	bl	_compiler_codegen_codegen_is_string_eq_op
	mov	x1, x0
	mov	x0, x19
	ldr	x19, [x29, 64]
	mov	x2, #16
	...
	ldr	x0, [x29, 48]
	mov	x2, x27
	bl	_compiler_codegen_codegen_is_float_eq_op
	mov	x2, x0
	mov	x0, x24
	ldr	x1, [x29, 40]
	mov	x3, #16
	...
	mov	x24, x0
	mov	x0, x27
	bl	_compiler_codegen_codegen_binop_to_qbe
	mov	x1, x0
	mov	x0, x24
	ldr	x26, [x1]
	mov	x2, #8
...
L323:
	...
	add	x1, x1, _compiler_codegen_il_Cned@pageoff
	mov	x25, x0
...
L325:
	...
	add	x1, x1, _compiler_codegen_il_Ceqd@pageoff
	mov	x25, x0
	adrp	x0, _compiler_codegen_il_Double@page
	add	x0, x0, _compiler_codegen_il_Double@pageoff
	bl	_compiler_codegen_il_Cmp
...
L328:
	...
	add	x1, x1, _compiler_codegen_il_Cnel@pageoff
	mov	x24, x0
	adrp	x0, _compiler_codegen_il_Long@page
	add	x0, x0, _compiler_codegen_il_Long@pageoff
	bl	_compiler_codegen_il_Cmp
...
L332:
	...
	add	x1, x1, _compiler_codegen_il_Ceql@pageoff
	mov	x24, x0
	adrp	x0, _compiler_codegen_il_Long@page
	add	x0, x0, _compiler_codegen_il_Long@pageoff
	bl	_compiler_codegen_il_Cmp
...
L335:
	...
	add	x0, x0, x1
	ldr	x0, [x0]
	bl	_compiler_codegen_codegen_ensure_string_concat_helper
	bl	_compiler_codegen_codegen_fresh_temp
	ldr	x21, [x0]
	mov	x1, #8
	add	x0, x0, x1
...
L395:
	...
	mov	x21, x0
	mov	x0, x25
	bl	_compiler_codegen_codegen_state_globals
	mov	x1, x24
	mov	x24, x1
	mov	x1, x21
	bl	_donna_list_contains_str
...
L435:
	...
	add	x0, x0, x1
	ldr	x0, [x0]
	bl	_compiler_codegen_il_ConstFloat
	mov	x19, x0
	mov	x0, #24
	bl	_malloc
	mov	x2, x21
...
_compiler_codegen_codegen_gen_stmts_no_ret:
	...
	ldr	x19, [x3]
	mov	x20, x2
	bl	_compiler_codegen_codegen_gen_stmt_no_ret
	mov	x2, x0
	mov	x0, x19
	ldr	x1, [x2]
	mov	x3, #8
...
_compiler_codegen_codegen_gen_case:
	...
	mov	x0, #8
	bl	_compiler_codegen_il_Const
	bl	_compiler_codegen_il_Alloc8
	mov	x2, x25
	mov	x1, x22
	mov	x3, x0
	mov	x0, x21
...
_compiler_codegen_codegen_gen_case_clauses:
	...
	mov	x1, x25
	mov	x0, x22
	bl	_compiler_codegen_codegen_gen_pattern_check
	mov	x2, x26
	mov	x1, x20
	mov	x3, x0
	ldr	x0, [x29, 256]
...
L491:
	...
	mov	x22, x0
	ldr	x0, [x29, 144]
	bl	_compiler_codegen_codegen_push_block
	str	x0, [x29, 128]
	mov	x0, x22
	mov	x22, x0
	ldr	x0, [x29, 136]
	...
	mov	x22, x1
	mov	x1, x24
	bl	_compiler_codegen_codegen_store_result
	mov	x1, x0
	mov	x0, x26
	mov	x26, x0
	ldr	x0, [x29, 104]
...
L584:
	...
	mov	x0, x21
	mov	x21, x3
	adrp	x3, _compiler_codegen_il_Long@page
	add	x3, x3, _compiler_codegen_il_Long@pageoff
	str	x3, [x24]
	mov	x22, x1
	mov	x1, #8
	add	x1, x24, x1
...
_compiler_codegen_codegen_gen_list_pattern_check:
	...
	mov	x0, x25
	ldr	x3, [x29, 16]
	adrp	x2, _compiler_typesystem_types_TInt@page
	add	x2, x2, _compiler_typesystem_types_TInt@pageoff
	bl	_compiler_codegen_codegen_gen_pattern_check
	mov	x1, x0
	mov	x0, x22
	ldr	x22, [x1]
...
_compiler_codegen_codegen_gen_list:
	...
	mov	x19, x0
	mov	x0, x2
	bl	_compiler_codegen_codegen_ensure_nil_singleton
	mov	x21, x0
	mov	x0, x19
	bl	_donna_list_reverse
	mov	x19, x0
...
L830:
	...
	add	x1, x1, _compiler_codegen_il_Cged@pageoff
	adrp	x0, _compiler_codegen_il_Double@page
	add	x0, x0, _compiler_codegen_il_Double@pageoff
	bl	_compiler_codegen_il_Cmp
	mov	x20, x0
...
L831:
	...
	add	x1, x1, _compiler_codegen_il_Cled@pageoff
	adrp	x0, _compiler_codegen_il_Double@page
	add	x0, x0, _compiler_codegen_il_Double@pageoff
	bl	_compiler_codegen_il_Cmp
	mov	x20, x0
...
L832:
	...
	add	x1, x1, _compiler_codegen_il_Cgtd@pageoff
	adrp	x0, _compiler_codegen_il_Double@page
	add	x0, x0, _compiler_codegen_il_Double@pageoff
	bl	_compiler_codegen_il_Cmp
	mov	x20, x0
...
L833:
	...
	add	x1, x1, _compiler_codegen_il_Cltd@pageoff
	adrp	x0, _compiler_codegen_il_Double@page
	add	x0, x0, _compiler_codegen_il_Double@pageoff
	bl	_compiler_codegen_il_Cmp
	mov	x20, x0
...
L834:
	...
	add	x1, x1, _compiler_codegen_il_Sgel@pageoff
	adrp	x0, _compiler_codegen_il_Long@page
	add	x0, x0, _compiler_codegen_il_Long@pageoff
	bl	_compiler_codegen_il_Cmp
	mov	x20, x0
...
L835:
	...
	add	x1, x1, _compiler_codegen_il_Slel@pageoff
	adrp	x0, _compiler_codegen_il_Long@page
	add	x0, x0, _compiler_codegen_il_Long@pageoff
	bl	_compiler_codegen_il_Cmp
	mov	x20, x0
...
L836:
	...
	add	x1, x1, _compiler_codegen_il_Sgtl@pageoff
	adrp	x0, _compiler_codegen_il_Long@page
	add	x0, x0, _compiler_codegen_il_Long@pageoff
	bl	_compiler_codegen_il_Cmp
	mov	x20, x0
...
L837:
	...
	add	x1, x1, _compiler_codegen_il_Sltl@pageoff
	adrp	x0, _compiler_codegen_il_Long@page
	add	x0, x0, _compiler_codegen_il_Long@pageoff
	bl	_compiler_codegen_il_Cmp
	mov	x20, x0
...
L861:
	...
	mov	x22, x17
	bl	_compiler_codegen_il_Temporary
	bl	_compiler_codegen_il_Loadub
	mov	x1, x22
	mov	x3, x0
	mov	x0, x21
	adrp	x2, _compiler_codegen_il_Long@page
...
L899:
	...
	add	x1, x1, x2
	ldr	x19, [x1]
	bl	_compiler_codegen_codegen_ensure_int_to_string_helper
	mov	x1, x20
	mov	x2, x0
	mov	x0, x19
	bl	_compiler_codegen_codegen_gen_expr
...
L907:
	...
	add	x1, x1, x2
	ldr	x19, [x1]
	bl	_compiler_codegen_codegen_ensure_print_str_helper
	mov	x1, x20
	mov	x2, x0
	mov	x0, x19
	bl	_compiler_codegen_codegen_gen_expr

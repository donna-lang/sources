...
L46:
	...
	add	x1, x1, x2
	ldr	x1, [x1]
	bl	_errors_error_ParseUppercaseFnName
	bl	_compiler_parser_parse_result_PErr
	b	L70
L47:
	mov	x1, x19
...
L63:
	...
	add	x6, x6, x7
	ldr	x22, [x6]
	bl	_compiler_parser_ast_Function
	mov	x1, x22
...
L103:
	cmp	w1, #0
	bne	L105
	adrp	x0, _str814@page
	add	x0, x0, _str814@pageoff
	bl	_utilities_location_zero
	mov	x1, x0
	adrp	x0, _str813@page
	add	x0, x0, _str813@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	b	L160
L105:
...
L106:
	...
	add	x0, x0, x1
	ldr	x1, [x0]
	adrp	x0, _str784@page
	add	x0, x0, _str784@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	b	L160
L107:
...
L130:
	...
	bne	L132
	mov	x1, x22
	adrp	x0, _str702@page
	add	x0, x0, _str702@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x19]
	b	L160
...
L151:
	...
	bne	L153
	mov	x1, x26
	adrp	x0, _str672@page
	add	x0, x0, _str672@pageoff
	bl	_errors_error_ParseUnexpectedEof
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x20]
	b	L159
L153:
	...
	bl	_compiler_lexer_token_to_string
	mov	x2, x21
	adrp	x1, _str669@page
	add	x1, x1, _str669@pageoff
	bl	_errors_error_ParseUnexpectedToken
	bl	_compiler_parser_parse_result_PErr
	str	x0, [x20]
	b	L159
L154:
	...
	ldr	x3, [x29, 24]
	ldr	x2, [x29, 16]
	bl	_compiler_parser_ast_ExternalFn
	mov	x1, x22
	bl	_compiler_parser_parse_result_POk
	str	x0, [x21]
	b	L158

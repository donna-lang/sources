...
_cli_help_docs_help:
	...
	add	x0, x3, x0
	str	x19, [x0]
	adrp	x2, _str225@page
	add	x2, x2, _str225@pageoff
...
_cli_help_format_help:
	...
	bl	_malloc
	mov	x19, x0
	adrp	x0, _str246@page
	add	x0, x0, _str246@pageoff
	str	x0, [x19]
	mov	x0, #8
	add	x1, x19, x0
	...
	add	x0, x3, x0
	str	x19, [x0]
	adrp	x2, _str245@page
	add	x2, x2, _str245@pageoff
...
_cli_help_new_help:
	...
	mov	x0, #8
	add	x1, x20, x0
	adrp	x0, _str283@page
	add	x0, x0, _str283@pageoff
	str	x0, [x1]
	mov	x0, #24
	bl	_malloc
	mov	x3, x0
	...
	add	x0, x3, x0
	str	x19, [x0]
	adrp	x2, _str273@page
	add	x2, x2, _str273@pageoff
...
_cli_help_run_help:
	...
	bl	_malloc
	mov	x20, x0
	adrp	x0, _str294@page
	add	x0, x0, _str294@pageoff
	str	x0, [x20]
	mov	x0, #8
	add	x1, x20, x0
	...
	add	x0, x3, x0
	str	x19, [x0]
	adrp	x2, _str293@page
	add	x2, x2, _str293@pageoff
...
_cli_help_test_help:
	...
	bl	_malloc
	mov	x20, x0
	adrp	x0, _str314@page
	add	x0, x0, _str314@pageoff
	str	x0, [x20]
	mov	x0, #8
	add	x1, x20, x0
	...
	bl	_malloc
	mov	x21, x0
	adrp	x0, _str322@page
	add	x0, x0, _str322@pageoff
	str	x0, [x21]
	mov	x0, #8
	add	x1, x21, x0
	...
	bl	_malloc
	mov	x21, x0
	adrp	x0, _str330@page
	add	x0, x0, _str330@pageoff
	str	x0, [x21]
	mov	x0, #8
	add	x1, x21, x0
	adrp	x0, _str331@page
	add	x0, x0, _str331@pageoff
	str	x0, [x1]
	mov	x0, #24
	bl	_malloc
	mov	x19, x0
	...
	add	x0, x3, x0
	str	x19, [x0]
	adrp	x2, _str313@page
	add	x2, x2, _str313@pageoff
...
_cli_help_version_help:
	...
	bl	_malloc
	mov	x20, x0
	adrp	x0, _str358@page
	add	x0, x0, _str358@pageoff
	str	x0, [x20]
	mov	x0, #8
	add	x1, x20, x0
	adrp	x0, _str359@page
	add	x0, x0, _str359@pageoff
	str	x0, [x1]
	mov	x0, #24
	bl	_malloc
	mov	x3, x0
	...
	add	x0, x3, x0
	str	x19, [x0]
	adrp	x2, _str349@page
	add	x2, x2, _str349@pageoff
...
_cli_help_option_row:
	...
	bl	_cli_help_pad_right
	mov	x1, x0
	adrp	x0, _str398@page
	add	x0, x0, _str398@pageoff
	bl	___rt_str_concat
	mov	x1, x19
	bl	___rt_str_concat
	ldr	x19, [x29, 24]

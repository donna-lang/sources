...
L24:
	cmp	w0, #0
	bne	L26
	adrp	x0, _str597@page
	add	x0, x0, _str597@pageoff
	...
	mov	x0, #8
	add	x1, x19, x0
	adrp	x0, _str596@page
	add	x0, x0, _str596@pageoff
	str	x0, [x1]
	mov	x0, #16
	add	x0, x19, x0
	str	x20, [x0]
...
L26:
	...
	mov	x0, #16
	add	x1, x19, x0
	adrp	x0, _str589@page
	add	x0, x0, _str589@pageoff
	str	x0, [x1]
	mov	x0, #24
	add	x0, x19, x0
	str	x20, [x0]
...
L39:
	...
	mov	x0, #16
	add	x1, x20, x0
	adrp	x0, _str552@page
	add	x0, x0, _str552@pageoff
	str	x0, [x1]
	mov	x0, #24
	add	x0, x20, x0
	str	x21, [x0]
...
L51:
	...
	mov	x0, #8
	add	x1, x22, x0
	adrp	x0, _str521@page
	add	x0, x0, _str521@pageoff
	str	x0, [x1]
	mov	x0, #16
	add	x0, x22, x0
	str	x25, [x0]
...
L73:
	...
	mov	x0, #16
	add	x1, x20, x0
	adrp	x0, _str352@page
	add	x0, x0, _str352@pageoff
	str	x0, [x1]
	mov	x0, #24
	add	x0, x20, x0
	str	x21, [x0]
...
L133:
	cmp	w1, #0
	bne	L135
	adrp	x0, _str754@page
	add	x0, x0, _str754@pageoff
	bl	_utilities_location_zero
	mov	x22, x0
	mov	x0, #24
	bl	_malloc
	...
	mov	x0, #8
	add	x1, x21, x0
	adrp	x0, _str753@page
	add	x0, x0, _str753@pageoff
	str	x0, [x1]
	mov	x0, #16
	add	x0, x21, x0
	str	x22, [x0]

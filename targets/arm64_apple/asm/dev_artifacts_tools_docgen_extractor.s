...
L29:
	...
	add	x1, x1, _donna_nil@pageoff
	str	x1, [x19]
	adrp	x23, _donna_nil@page
	add	x23, x23, _donna_nil@pageoff
L32:
	mov	x19, x0
	mov	x0, #48
	bl	_malloc
...
L74:
	...
	str	x1, [x22]
	adrp	x24, _str350@page
	add	x24, x24, _str350@pageoff
L77:
	mov	x22, x0
	mov	x0, #40
	bl	_malloc
...
_tools_docgen_extractor_render_fn_sig:
	...
	cmp	x1, #1
	beq	L86
	adrp	x19, _str373@page
	add	x19, x19, _str373@pageoff
	b	L87
L86:
	adrp	x19, _str372@page
	add	x19, x19, _str372@pageoff
L87:
	adrp	x1, _donna_nil@page
	add	x1, x1, _donna_nil@pageoff
...
L89:
	...
	str	x2, [x19]
	adrp	x19, _str384@page
	add	x19, x19, _str384@pageoff
L92:
	mov	x21, x1
...
_tools_docgen_extractor_is_doc_line:
	...
	adrp	x1, _str577@page
	add	x1, x1, _str577@pageoff
	mov	x19, x0
...
L155:
	...
	b	L157
L156:
	adrp	x0, _str623@page
	add	x0, x0, _str623@pageoff
L157:
	ldr	x19, [x29, 24]
	mov sp, x29
	ldp	x29, x30, [sp], 32

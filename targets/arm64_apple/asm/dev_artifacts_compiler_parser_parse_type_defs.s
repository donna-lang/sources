...
L106:
	cmp	w1, #0
	bne	L108
	adrp	x0, _str601@page
	add	x0, x0, _str601@pageoff
	bl	_utilities_location_zero
	mov	x20, x0
	mov	x0, #24
	bl	_malloc
	...
	mov	x0, #8
	add	x1, x19, x0
	adrp	x0, _str600@page
	add	x0, x0, _str600@pageoff
	str	x0, [x1]
	mov	x0, #16
	add	x0, x19, x0
	str	x20, [x0]
...
L108:
	...
	mov	x0, #16
	add	x1, x19, x0
	adrp	x0, _str593@page
	add	x0, x0, _str593@pageoff
	str	x0, [x1]
	mov	x0, #24
	add	x0, x19, x0
	str	x20, [x0]
...
L128:
	...
	mov	x0, #16
	add	x1, x19, x0
	adrp	x0, _str763@page
	add	x0, x0, _str763@pageoff
	str	x0, [x1]
	mov	x0, #24
	add	x0, x19, x0
	str	x20, [x0]
...
L153:
	...
	mov	x2, #8
	add	x3, x1, x2
	adrp	x2, _str937@page
	add	x2, x2, _str937@pageoff
	str	x2, [x3]
	mov	x22, x1
	mov	x1, #16
	add	x1, x22, x1

...
_compiler_parser_parser_parse:
	...
	bl	_compiler_parser_parser_parse_module_loop
	ldp	x29, x30, [sp], 16
	ret
...
L90:
	...
	mov	x21, x0
	mov	x0, x20
	bl	_compiler_parser_parser_sync_to_decl
	mov	x20, x0
	mov	x0, #24
	bl	_malloc
	mov	x3, x26
...
L92:
	...
	mov	x19, x0
	mov	x0, x21
	bl	_compiler_parser_parse_type_defs_parse_type_def
	mov	x5, x25
	mov	x4, x24
	mov	x3, x23
	mov	x2, x20
...
L112:
	...
	mov	x19, x0
	mov	x0, x21
	bl	_compiler_parser_parse_functions_parse_external_fn
	mov	x5, x25
	mov	x4, x24
	mov	x3, x23
	mov	x2, x20
...
L117:
	...
	mov	x19, x0
	mov	x0, x21
	bl	_compiler_parser_parse_functions_parse_function
	mov	x5, x25
	mov	x4, x24
	mov	x3, x23
	mov	x2, x20
...
L127:
	...
	mov	x19, x0
	mov	x0, x21
	bl	_compiler_parser_parse_constants_parse_const
	mov	x5, x25
	mov	x4, x24
	mov	x3, x23
	mov	x2, x20
...
L137:
	...
	mov	x19, x0
	mov	x0, x21
	bl	_compiler_parser_parse_imports_parse_import
	mov	x5, x25
	mov	x4, x24
	mov	x3, x22
	mov	x2, x20
...
L142:
	...
	b	L146
L144:
	bl	_compiler_parser_parser_make_output
	b	L146
L145:
	bl	_compiler_parser_parser_make_output
L146:
...
_compiler_parser_parser_make_output:
	...
	bl	_compiler_parser_parser_ParseErrors
	b	L151
L149:
	mov	x0, x23
	bl	_donna_list_reverse
	...
	mov	x4, x0
	mov	x0, x19
	bl	_compiler_parser_ast_Module
	bl	_compiler_parser_parser_ParseOk
L151:
	ldr	x19, [x29, 56]
	ldr	x20, [x29, 48]
	ldr	x21, [x29, 40]
...
_compiler_parser_parser_sync_to_decl:
	...
	ldr	x0, [x0]
	bl	_compiler_parser_parse_result_skip_newlines
	bl	_compiler_parser_parser_sync_rest
	b	L155
L154:
